    ...
    return (
        <React.Fragment>
            <div className="w3-content w3-container w3-padding-64" id="portfolio">
                ...
                <p className="w3-center"><em>Here are some of my latest lorem work ipsum tipsum.<br/> Click on the
                    images to make them bigger</em></p><br/>
                ...
                <div className="w3-row-padding w3-center w3-section">
                    ...
                    <button className="w3-button w3-padding-large w3-light-grey" style={{ marginTop: '64px'}}>LOAD MORE
                    </button>
                </div>
            </div>
